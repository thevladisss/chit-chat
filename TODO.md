...
- [x] Wire validateMessageRequest/handleValidationErrors into chat.route.ts — POST /:chatId/messages currently accepts unvalidated bodies
...
### Refactor
- [ ] Migrate backend from raw ws to Socket.io for horizontal scalability (socket.io-redis-adapter) — see backend/TRADEOFF.md
