import * as messageMapper from '../../../src/mappers/message.mapper';
import { TextMessageResponse } from '../../../src/types/responses';
...
describe('message.mapper', () => {
  ...
  describe('mapMessagesToResponse', () => {
    ...
    it('should map array of messages to response format', () => {
      ...
      const result = messageMapper.mapMessagesToResponse(
        currentUserId,
        messages,
