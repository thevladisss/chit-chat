...
const validateSendChatMessageRequest = (_req: Request, _res: Response, _next: NextFunction): void => {};
...
export const validateMessageRequest = [
  ...
  param('type')
    ...
    .withMessage(
      `Message type must be either "${ChatMessageTypeEnum.TEXT}" or "${ChatMessageTypeEnum.AUDIO}"`,
    ),
    ...
    [
      ...
      [
        body('audioUrl')
          ...
          .matches(/^\/uploads\/audio\/[a-zA-Z0-9\-_]+\.(webm|mp4|wav|ogg|m4a)$/)
